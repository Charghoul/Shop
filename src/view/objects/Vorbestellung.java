...
import view.VorbestellungView;
import view.visitor.*;


/* Additional import section end */

public class Vorbestellung extends view.objects.Bestellstatus implements VorbestellungView{
    
    
    public Vorbestellung(long id, long classId) {
