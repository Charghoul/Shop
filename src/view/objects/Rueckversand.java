...
import view.RueckversandView;
import view.visitor.*;


/* Additional import section end */

public class Rueckversand extends view.objects.Bestellstatus implements RueckversandView{
    
    
    public Rueckversand(long id, long classId) {
