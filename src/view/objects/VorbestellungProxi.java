...
public class VorbestellungProxi extends BestellstatusProxi implements VorbestellungView{
    ...
    public VorbestellungView getRemoteObject(java.util.HashMap<String,Object> resultTable, ExceptionAndEventHandler connectionKey) throws ModelException{
        VorbestellungView result$$ = new Vorbestellung( this.getId(), this.getClassId());
