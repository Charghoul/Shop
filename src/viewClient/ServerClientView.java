	...
	public void initializeConnection(){
		try {
			this.getService().getService().accept(new ServiceVisitor() {
				...
				@Override
				public void handleServiceKunde(ServiceKundeView customerService) throws ModelException {
					ServiceKundeClientView view = new ServiceKundeClientView(ServerClientView.this, customerService);
					customerService.connectServiceKunde(ServerClientView.this.getConnection(), view);
					ServerClientView.this.setCenter(view);
				}

				@Override
				public void handleServiceAdmin(ServiceAdminView shopownerService) throws ModelException {
					ServiceAdminClientView view = new ServiceAdminClientView(ServerClientView.this, shopownerService);
					shopownerService.connectServiceAdmin(ServerClientView.this.getConnection(), view);
					ServerClientView.this.setCenter(view);
				}

				@Override
				public void handleServiceRegister(ServiceRegisterView registerService) throws ModelException {
					ServiceRegisterClientView view = new ServiceRegisterClientView(ServerClientView.this, registerService);
					registerService.connectServiceRegister(ServerClientView.this.getConnection(), view);
					ServerClientView.this.setCenter(view);
				}
			});
