...
public class ServiceRegisterConnection extends ServiceConnection {

	public ServiceRegisterConnection (String url, ExceptionAndEventHandler handler, ClientReporter reporter) throws MalformedURLException {
		super(url, handler, reporter);
	}

	public ServiceRegisterView getServiceRegisterView(){
		return (ServiceRegisterView)super.getServer();
	}

    public synchronized String serviceRegister_Menu_Filter(Anything anything) throws ModelException{
        try {
            ...
            java.util.HashMap<?,?> success = (java.util.HashMap<?,?>)this.execute(this.connectionName, "serviceRegister_Menu_Filter", parameters);
    ...
    public synchronized void register(String username, String passwort) throws ModelException, ExcUserAlreadyExists{
        try {
            Vector<Object> parameters = new Vector<Object>();
            parameters.add(username);
            parameters.add(passwort);
