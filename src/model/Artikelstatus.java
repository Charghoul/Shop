...
public abstract class Artikelstatus extends PersistentObject implements PersistentArtikelstatus{
    ...
    public Artikelstatus(SubjInterface subService,PersistentArtikelstatus This,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if(this.getSubService() != null){
            ...
            ConnectionHandler.getTheConnectionHandler().theArtikelstatusFacade.subServiceSet(this.getId(), getSubService());
        }
    ...
    public void setSubService(SubjInterface newValue) throws PersistenceException {
        ...
        if(!this.isDelayed$Persistence()){
            newValue.store();
            ConnectionHandler.getTheConnectionHandler().theArtikelstatusFacade.subServiceSet(this.getId(), newValue);
        }
    }
