...
public class Angenommen extends model.Bestellstatus implements PersistentAngenommen{
    ...
    public static Angenommen4Public createAngenommen() throws PersistenceException{
        return createAngenommen(false);
    }
    
    public static Angenommen4Public createAngenommen(boolean delayed$Persistence) throws PersistenceException {
        PersistentAngenommen result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theAngenommenFacade
                .newDelayedAngenommen();
    ...
    public static Angenommen4Public createAngenommen(boolean delayed$Persistence,Angenommen4Public This) throws PersistenceException {
        PersistentAngenommen result = null;
        if(delayed$Persistence){
            result = ConnectionHandler.getTheConnectionHandler().theAngenommenFacade
                .newDelayedAngenommen();
    ...
    public Angenommen provideCopy() throws PersistenceException{
        ...
        result = new Angenommen(this.This, 
                                this.getId());
    ...
    public Angenommen(PersistentBestellstatus This,long id) throws PersistenceException {
    ...
    public void store() throws PersistenceException {
        ...
        if (this.getClassId() == 219) ConnectionHandler.getTheConnectionHandler().theAngenommenFacade
            .newAngenommen(this.getId());
        super.store();
