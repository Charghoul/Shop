...
public interface AnythingReturnVisitor<R> extends ArtikelstatusReturnVisitor<R> ,BestellstatusReturnVisitor<R> ,CommonDateReturnVisitor<R> ,ServiceReturnVisitor<R> {
