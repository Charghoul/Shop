...
public interface AnythingReturnVisitor<R> extends ArtikelstatusReturnVisitor<R> ,BestellstatusReturnVisitor<R> ,BooleanXReturnVisitor<R> ,CommonDateReturnVisitor<R> ,ServiceReturnVisitor<R> {
    ...
    public R handleArtikel(Artikel4Public artikel) throws PersistenceException;
