...
//			oracleConnection.setImplicitCachingEnabled(true);
            ...
            this.theHstLieferungFacade= new HstLieferungFacade(this.schemaName, this.con);
            this.theKndLieferungFacade= new KndLieferungFacade(this.schemaName, this.con);
            ...
            this.theThreadOfControlFacade= new ThreadOfControlFacade(this.schemaName, this.con);
            this.theZeitObjektFacade= new ZeitObjektFacade(this.schemaName, this.con);
            ...
            this.theZeitManagerFacade= new ZeitManagerFacade(this.schemaName, this.con);
            ...
            this.theIntegerWrapperFacade= new IntegerWrapperFacade(this.schemaName, this.con);
