...
public class PositionFacade{
    ...
    public PersistentPosition newPosition(long menge,long idCreateIfLessZero) throws PersistenceException {
        if(idCreateIfLessZero > 0) return (PersistentPosition)PersistentProxi.createProxi(idCreateIfLessZero, 125);
        ...
        return (PersistentPosition)PersistentProxi.createProxi(id, 125);
    }
