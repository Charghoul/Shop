...
public class WarenlagerProxi extends PersistentProxi implements PersistentWarenlager{
    
    public WarenlagerProxi(long objectId) {
        super(objectId);
    }
    public WarenlagerProxi(PersistentInCacheProxi object) {
        super(object);
    }
