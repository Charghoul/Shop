...
public class ServiceRegisterProxi extends ServiceProxi implements PersistentServiceRegister{
    
    public ServiceRegisterProxi(long objectId) {
        super(objectId);
    }
    public ServiceRegisterProxi(PersistentInCacheProxi object) {
        super(object);
    }
