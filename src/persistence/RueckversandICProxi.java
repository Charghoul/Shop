...
public class RueckversandICProxi extends BestellstatusICProxi implements PersistentRueckversand{
    
    public RueckversandICProxi(long objectId) {
        super(objectId);
    }
    public RueckversandICProxi(PersistentObject object) {
        super(object);
    }
    
    protected PersistentObject getRemote() throws PersistenceException {
        return ConnectionHandler.getTheConnectionHandler().theRueckversandFacade
            .getRueckversand(this.getId());
    }
