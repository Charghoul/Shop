...
public class HinversandProxi extends BestellstatusProxi implements PersistentHinversand{
    
    public HinversandProxi(long objectId) {
        super(objectId);
    }
    public HinversandProxi(PersistentInCacheProxi object) {
        super(object);
    }
    ...
    public void deregister(final ObsInterface observee) 
        ...
        ((PersistentHinversand)this.getTheObject()).deregister(observee);
    }
    ...
    public void register(final ObsInterface observee) 
				throws PersistenceException{
        ((PersistentHinversand)this.getTheObject()).register(observee);
    }
    public void updateObservers(final model.meta.Mssgs event) 
				throws PersistenceException{
        ((PersistentHinversand)this.getTheObject()).updateObservers(event);
    }
