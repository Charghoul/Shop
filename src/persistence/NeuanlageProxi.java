...
public class NeuanlageProxi extends ArtikelstatusProxi implements PersistentNeuanlage{
    
    public NeuanlageProxi(long objectId) {
        super(objectId);
    }
    public NeuanlageProxi(PersistentInCacheProxi object) {
        super(object);
    }
