...
/* ********************* Cache report ********************** */	
	...
	private void initializeNumber2NameMap() {
		...
		this.number2NameMap.put(102, "ArtikelEntfernenCommand");
		...
		this.number2NameMap.put(107, "HerstellerManager");
		this.number2NameMap.put(172, "Hinversand");
		this.number2NameMap.put(114, "HstLieferung");
		this.number2NameMap.put(117, "KndAnnahme");
		this.number2NameMap.put(115, "KndLieferung");
		this.number2NameMap.put(132, "Konto");
		this.number2NameMap.put(168, "Kunde");
		this.number2NameMap.put(147, "KundenManager");
		...
		this.number2NameMap.put(119, "ProduktKatalog");
		...
		this.number2NameMap.put(-101, "Server");
		this.number2NameMap.put(-127, "ServiceAdmin");
		this.number2NameMap.put(126, "ServiceAdminKundenManager");
		...
		this.number2NameMap.put(139, "Warenlager");
		this.number2NameMap.put(163, "ZeitManager");
		this.number2NameMap.put(152, "ZeitManagerZeitObjektListe");
		this.number2NameMap.put(118, "ZuEinkaufswHinzCommand");
		this.number2NameMap.put(136, "ZuruecksendenCommand");
		this.number2NameMap.put(176, "activated");
		this.number2NameMap.put(110, "deactivated");	
	}
