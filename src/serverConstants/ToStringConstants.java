...
public class ToStringConstants {
    ...
    public static final String Artikelstatus = "";
    ...
    public static final String RetourePosition = "Positionsrücksendung";
    public static final String RetoureLieferung = "Lieferungsrücksendung";
